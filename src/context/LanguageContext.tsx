...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "pricing.subtitle": "Priced by fractions — scale as your portfolio grows",
    ...
    "pricing.enterprise.desc": "A tailored solution for large-scale operations",
    "pricing.enterprise.body": "Need more? If these plans don't suit your needs, talk to us and we'll build a custom solution for your portfolio.",
    "pricing.enterprise.cta": "Contact Us",
    "pricing.mostPopular": "Most Popular",
    "pricing.month": "/month",
    "pricing.getStarted": "Get Started",
    "pricing.starterUnits": "Up to 50 fractions",
    "pricing.growthUnits": "Up to 100 fractions",
    "pricing.proUnits": "Up to 500 fractions",
  ...
  pt: {
    ...
    "pricing.subtitle": "Preços por frações — cresça ao ritmo do seu portfólio",
    "pricing.starter": "Starter",
    ...
    "pricing.enterprise": "Enterprise",
    "pricing.enterprise.desc": "Uma solução à medida para operações de grande escala",
    "pricing.enterprise.body": "Precisa de mais? Se os nossos planos não se adequam às suas necessidades, fale connosco e criamos uma solução personalizada para o seu portfólio.",
    "pricing.enterprise.cta": "Contacte-nos",
    "pricing.mostPopular": "Mais Popular",
    "pricing.month": "/mês",
    "pricing.getStarted": "Começar",
    "pricing.starterUnits": "Até 50 frações",
    "pricing.growthUnits": "Até 100 frações",
    "pricing.proUnits": "Até 500 frações",
